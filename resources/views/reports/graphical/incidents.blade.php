...
@section('title', 'Incident Frequency — Graphical Report')

@section('page-header')
<div class="d-flex justify-content-between align-items-center mb-3">
    <div>
        <h4 class="page-title mb-0"><i class="fas fa-chart-column me-2"></i>Incident Frequency</h4>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('reports.index') }}">Reports</a></li>
                <li class="breadcrumb-item"><a href="{{ route('reports.graphical') }}">Graphical</a></li>
                <li class="breadcrumb-item active">Incident Frequency</li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <div class="card-body py-3">
        <div class="row g-3 align-items-end">
            ...
            <div class="col-auto" id="annualControls">
                ...
                <div class="d-flex flex-wrap gap-2">
                    ...
                    @if($availableYears->isEmpty())
                        <span class="text-muted small">No incident data yet.</span>
                    @endif
                </div>
            </div>
            ...
            <div class="col-auto ms-auto">
                <span id="modeBadge" class="badge bg-warning bg-opacity-15 text-warning">Annual Comparison</span>
            </div>
        </div>
    </div>
</div>
...
<div class="card border-0 shadow-sm">
    <div class="card-body">
        ...
        <div id="noDataMsg" class="text-center py-5 d-none">
            <i class="fas fa-chart-column fa-2x text-muted mb-2"></i><br>
            <span class="text-muted">No incident data for the selected filters.</span>
        </div>
...
<script>
const DATA_URL = '{{ route("reports.graphical.incidents.data") }}';
let chart = null;
...
function getMonthlyYear() {
    return document.getElementById('monthlyYear').value;
}
