...
return new class {
    public function run(PDO $pdo): void {
        ...
        // ── Barangays ──────────────────────────
        $barangays = [
            [1,  'Buenavista',             2450, 15.20, '12.8472,120.7803'],
            [2,  'Burgos',                 1890, 12.80, '12.6947,120.8862'],
            [3,  'Claudio Salgado',        1560, 10.55, '12.730611,120.833989'],
            [4,  'Poblacion',              3210, 18.60, '12.8347,120.7684'],
            [6,  'Batong Buhay',           2150, 13.40, '12.8166,120.8652'],
            [7,  'Gen. Emilio Aguinaldo',  1980, 11.90, '12.7300,120.8354'],
            [8,  'Ibud',                   2600, 14.50, '12.8849,120.8060'],
            [9,  'Ligaya',                 2700, 16.10, '12.7232,120.8554'],
            [10, 'San Agustin',            1950, 12.00, '12.9230,120.9057'],
            [11, 'San Francisco',          2400, 13.80, '12.8935,120.8677'],
            [13, 'San Nicolas',            2100, 11.70, '12.7262,120.8158'],
            [14, 'San Vicente',            2500, 14.10, '12.8836,120.8309'],
            [15, 'Santa Lucia',            2300, 13.20, '12.7568,120.7945'],
            [17, 'Victoria',               2150, 13.60, '12.9285,120.8395'],
            [18, 'Paetan',                 1800, 11.20, '12.9126,120.8541'],
            [19, 'Lagnas',                 1900, 12.00, '12.9327,120.8633'],
            [21, 'Pag-asa',                1750, 10.80, '13.0587,121.0514'],
            [22, 'Tuban',                  1850, 11.60, '12.8063,120.8384'],
            [23, 'Ilvita',                 2600, 14.50, '12.9602,120.8176'],
            [24, 'Malisbong',              2700, 16.10, '12.7701,120.8432'],
            [25, 'Santo Niño',             2100, 11.70, '12.8630,120.7905'],
            [26, 'Tagumpay',               1850, 11.60, '12.9112,120.8096'],
        ];
